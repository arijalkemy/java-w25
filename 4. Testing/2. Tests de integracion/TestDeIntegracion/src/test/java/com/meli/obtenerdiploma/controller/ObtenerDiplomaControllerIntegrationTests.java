...
public class ObtenerDiplomaControllerIntegrationTests {
    ...
    public void analyzeScoresTestOKNoBest() throws Exception {
        ...
        expected.setMessage("El alumno Lucho ha obtenido un promedio de 7,33. Puedes mejorar.");
    ...
    public void analyzeScoresTestOKBest() throws Exception {
        ...
        expected.setMessage("El alumno Martin ha obtenido un promedio de 10,00. Felicitaciones!");
