...
@DirtiesContext(classMode = DirtiesContext.ClassMode.AFTER_EACH_TEST_METHOD) // esta anotacion elimina el contexto de clases generado en las bases de datos generados por los tests
public class StudentIntegrationTest {
    ...
    public void listStudentsOK() throws Exception { // get
        ...
        List<SubjectDTO> subjects = new ArrayList<>(List.<SubjectDTO>of(subject3, subject1, subject2));
        ...
        SubjectDTO subjectA1 = new SubjectDTO("Fisica", 8D);
        SubjectDTO subjectB1 = new SubjectDTO("Quimica", 7D);
