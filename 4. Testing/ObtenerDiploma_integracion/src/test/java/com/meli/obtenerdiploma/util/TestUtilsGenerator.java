...
public class TestUtilsGenerator {
    ...
    public static StudentDTO getStudentWithId2(Long id) {
        SubjectDTO subject1 = new SubjectDTO("Matemática", 8.0);
        SubjectDTO subject2 = new SubjectDTO("Lengua", 6.0);
        SubjectDTO subject3 = new SubjectDTO("Física", 4.0);
    ...
    public static Set<StudentDTO> getStudentSet2() {
        StudentDTO stu1 = new StudentDTO(1L, "Juan", null, null, List.of(
                new SubjectDTO("Matemática", 8.0),
                new SubjectDTO("Lengua", 6.0),
                new SubjectDTO("Física", 4.0)
        ));
        StudentDTO stu2 = new StudentDTO(2L, "Pedro", null, null, List.of(
