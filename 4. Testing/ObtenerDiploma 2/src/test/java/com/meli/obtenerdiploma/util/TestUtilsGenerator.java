...
public class TestUtilsGenerator {
    ...
    public static StudentDTO generateGoodStudentDto(Long id){
        return new StudentDTO(
                id,
                "pepe",
                "El alumno pepe ha obtenido un promedio de 10.00. Felicitaciones!",
                10.0,
                generateGoodSubjects()
        );
    }

    public static StudentDTO generateBadStudentDto(Long id){
        return new StudentDTO(
                id,
                "pepe",
                "El alumno pepe ha obtenido un promedio de 1.00. Puedes mejorar.",
                1.0,
                generateBadSubjects()
        );
    }
