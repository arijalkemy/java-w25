...
public class TestUtilsGenerator {
    ...
    public static StudentDTO getStudentFromDatabase() {
    ...
    public static Set<StudentDTO> getStudentSetFromDatabase() {
        StudentDTO stu1 = getStudentFromDatabase();
        StudentDTO stu2 = getStudentFromDatabase2();

        return new HashSet<StudentDTO>(){{add(stu1); add(stu2);}};
    }
