...
class StudentControllerIntegrationTest {
    //TODO: para cada test, mantener diferentes usuarios.
    //TODO: modificar el test para utlizar los objetos en cada caso de test.
    //NOTA: en bases de datos, utilizar H2.
    ...
    void getStudentOK() throws Exception {
        ...
        Assertions.assertEquals(SerializeMock(studentDTOExpected),(respose.getResponse().getContentAsString()));
    }
    @Test
