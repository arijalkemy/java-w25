...
class CalculadoraRestControllerTest {
    @Autowired
    private MockMvc mockMvc;

    // a) Objeto que diga la cantidad totales de metros cuadrados de la casa:
    @Test
    void calculateM2HouseTest() throws Exception {
    ...
    @Test
    void calculateHousePriceTest() throws Exception {
        String request = "{\"name\": \"Oficina\", \"address\": \"Monroe 800\", \"rooms\": [" +
    ...
    // d) Retorna la cantidad de metros cuadrados por habitación:
    @Test
