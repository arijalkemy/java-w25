...
public class TestUtilsGenerator {
    ...
    public static StudentDTO getStudentDTOForAnalyzeScores() {
        return new StudentDTO(
                1L,
                "Juan", "El alumno Juan ha obtenido un promedio de 7.33. Puedes mejorar.",
                7.333333333333333,
                List.of(
    ...
    public static StudentDTO getStudentDTO_1() {
        return new StudentDTO(
                1L,
                "Juan",
                null,
    ...
    public static Set<StudentDTO> getAllStudentsSet() {
        ...
        return Set.of(juan, pedro);
    }

    public static List<StudentDTO> getSetup() {
        StudentDTO juan = new StudentDTO(
                1L,
                "Juan",
                null,
