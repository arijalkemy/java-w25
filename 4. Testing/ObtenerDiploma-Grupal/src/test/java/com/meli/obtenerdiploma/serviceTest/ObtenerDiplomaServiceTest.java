...
public class ObtenerDiplomaServiceTest {
    ...
    void analyzeScoresTest(){
        ...
        StudentDTO studentDTOExpected = new StudentDTO(1L, "Pedro", "El alumno Pedro ha obtenido un promedio de 4.30. Felicitaciones!" , 4.30, subjectDTOList);
        ...
        //ACT
        studentDTOResult = obtenerDiplomaService.analyzeScores(1L);
        //ASSERT
