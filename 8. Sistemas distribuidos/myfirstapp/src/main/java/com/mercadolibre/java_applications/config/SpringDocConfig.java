package com.mercadolibre.java_applications.config;

import static com.mercadolibre.java_applications.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.java_applications.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("mramosgarcia")
                .email("miguel.ramosgarcia@mercadolibre.com.co"));
