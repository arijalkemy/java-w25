...
public class ItemPriceController {
    ...
    @GetMapping("/prices/{itemId}/usd")
    public ItemDTO getItemPriceUsd(@PathVariable String itemId,
                                   @RequestParam(name = "currency_to") String currencyTo) throws ParseException, RestException {
        return itemsService.getItemPriceConverted(itemId, currencyTo);
    }
}
