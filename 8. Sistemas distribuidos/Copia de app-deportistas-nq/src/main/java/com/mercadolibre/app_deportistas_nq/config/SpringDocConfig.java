...
import static com.mercadolibre.app_deportistas_nq.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.app_deportistas_nq.util.ScopeUtils.isLocalScope;
    ...
    public OpenAPI customOpenAPI(
        ...
        Info info = new Info()
                ...
                .contact(
                        new Contact()
                                .name("nquilpatay")
                                .email("nahuel.quilpatay@mercadolibre.com"));
