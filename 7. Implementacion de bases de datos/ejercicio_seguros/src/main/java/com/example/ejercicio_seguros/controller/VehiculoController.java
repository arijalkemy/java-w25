...
public class VehiculoController {
    ...
    public ResponseEntity<?> geetAllPatentesAndMarcas(){
        return ResponseEntity.ok().body(this.vehiculoService.listPaMarcaVehiculos());
    }

    @GetMapping("/filtro")
    public ResponseEntity<?> getAllPatenteByRuedasAndAnio(@RequestParam("cantRuedas") Integer cantRuedas,
