...
public class ClothesController {
    ...
    public ResponseEntity<ClotheDto> getClotheByCode(@PathVariable String code){
        return new ResponseEntity<>(clothesService.getClotheByCode(code), HttpStatus.OK);
    }

    //Actualizar una prenda en particular
    @PutMapping("/{code}")
    public ResponseEntity<ConfirmationMessage> updateClothes(@RequestBody ClotheReqDto clothesDTO, @PathVariable String code){
    ...
    @DeleteMapping("/{code}")
    public ResponseEntity<ConfirmationMessage> deleteClothes(@PathVariable String code){
