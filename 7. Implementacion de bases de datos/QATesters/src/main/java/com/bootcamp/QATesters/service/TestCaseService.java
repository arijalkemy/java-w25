...
public class TestCaseService implements ItestCaseService{
    ...
    public SucessDTO saveTestCase(TestCaseDTO testCaseDTO) {
        ...
        return new SucessDTO("Created Succesfully");
    ...
    public SucessDTO updateTestCase(Long id, TestCaseDTO testCaseDTO){
        ...
        if(testCaseDTO.getNumber_of_tries() != null){
            foundTestCase.setNumber_of_tries(testCaseDTO.getNumber_of_tries());
        }
        if(testCaseDTO.getLast_update() != null){
            foundTestCase.setLastupdate(testCaseDTO.getLast_update());
