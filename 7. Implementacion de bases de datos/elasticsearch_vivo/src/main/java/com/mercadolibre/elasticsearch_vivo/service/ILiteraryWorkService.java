...
public interface ILiteraryWorkService {
    ...
    List<LiteraryWorkResponseDto> getLiteraryWorksByFirstPublishingYearBefore(int year);

    List<LiteraryWorkResponseDto> getLiteraryWorksByEditorial(String editorial);
}
