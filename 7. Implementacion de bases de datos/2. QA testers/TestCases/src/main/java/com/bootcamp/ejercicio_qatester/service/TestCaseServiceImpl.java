...
import com.bootcamp.ejercicio_qatester.repository.IProjectRepository;
...
public class TestCaseServiceImpl implements ITestCaseService {
    ...
    public TestCaseServiceImpl(ITestCaseRepository testCaseRepository, IProjectRepository projectRepository) {
    ...
    public TestCaseDTO createTestCase(TestCaseDTO testCase) {
        ...
        projectRepository.save(newTestCase.getProject());
