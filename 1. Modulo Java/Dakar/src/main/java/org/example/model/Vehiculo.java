...
public abstract class Vehiculo {
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(velocidad, vehiculo.velocidad) == 0 && Double.compare(aceleracion, vehiculo.aceleracion) == 0 && Double.compare(anguloDeGiro, vehiculo.anguloDeGiro) == 0 && Double.compare(peso, vehiculo.peso) == 0 && ruedas == vehiculo.ruedas && Objects.equals(patente, vehiculo.patente);
    }
