public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("La temp mínima es " + minValue + " y la ciudad es " + ciudades[minIndex]);
        System.out.println("La temp máxima es " + maxValue + " y la ciudad es " + ciudades[maxIndex]);
    }
}
