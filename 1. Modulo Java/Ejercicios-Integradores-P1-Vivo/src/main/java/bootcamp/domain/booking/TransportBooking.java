...
public class TransportBooking implements Booking {
    ...
    public TransportBooking(double price) {
        this.booking = new BookingBase();
        this.price = price;
    }
    public TransportBooking(Booking booking, double price) {
    ...
    public String getKey() {
        return booking.getKey() + Main.transportBooking();
    }

    @Override
    public String getKeyWithPrice() {
        return booking.getKey() + Main.transportBooking() + "($" + price + ")";
    }
