...
public class PostServiceTest {
    ...
    void createPostTestError(){
        ...
        ProductDTO productDTO = ProductDTO.builder()
                ...
                .build();
        PostRequestDTO postRequestDTO = new PostRequestDTO(1, "14-02-2025", productDTO, 123, 1020.65);
        //Act
        //Assert
        assertThrows(BadRequestException.class, () -> {postService.createPost(postRequestDTO);} );
    }
    @Test
    void createPostUserNotExistTestError(){
        //Arrange
        Integer userId = 100;
        ProductDTO productDTO = ProductDTO.builder()
                .productId(23)
                ...
                .notes("unico color, puro algodon")
                .build();
        PostRequestDTO postRequestDTO = new PostRequestDTO(userId, "14-02-2024", productDTO, 123, 1020.65);
        //Act
        //Assert
        assertThrows(NotFoundException.class, () -> {postService.createPost(postRequestDTO);},"No se puede crear el post ya que el usuario con id " + userId + " no existe." );
    }
    @Test
    void createPostUserIsNotSellerTestError(){
        //Arrange
        Integer userId = 1;
        ProductDTO productDTO = ProductDTO.builder()
                .productId(23)
                ...
                .build();
        PostRequestDTO postRequestDTO = new PostRequestDTO(userId, "14-02-2024", productDTO, 123, 1020.65);
        Optional<User> user = Optional.of(new Buyer(1,"buyer", "buyer@test.com"));
        when(userRepository.findById(userId)).thenReturn(user);
        //Act
        //Assert
        assertThrows(BadRequestException.class, () -> {postService.createPost(postRequestDTO);},"El usuario no es un vendedor. No se puede concretar la operación.");
    }
