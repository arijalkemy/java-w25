...
//Posts ready to be ordered
    ...
    public static PostCreatedDto postCreatedOutput(){
        return new PostCreatedDto(2,
                "2024-01-01",
                new Product(1,
                        1,
                        3.0,
    ...
    public static PostCreatedDto postCreatedEntry(){
        return new PostCreatedDto(2,
                "01-01-2024",
                new Product(1,
                        1,
    ...
    public static List<User> followedAsc(){
    ...
    public static List<User> followedDesc(){
        List<User> usersExpected = List.of(
                new User(2, "user2", "lastName", RolEnum.SELLER ),
                new User(1, "user1", "lastName", RolEnum.SELLER )
        );
