...
public class ObjectFactory {
    ...
    public Client getOneClientFromDB(ClientRepositoryImp cRepo) {
        return cRepo.findOne(6);
        //return new Client(6, "Martin Perez", new ArrayList<>());
    }

    public Vendor getOneVendorFromDB(VendorRepositoryImp vRepo) {
        return vRepo.findOne(1);
        //return new Vendor(1, "Fernando Gómez", new ArrayList<>(), new ArrayList<>());
    }
}
