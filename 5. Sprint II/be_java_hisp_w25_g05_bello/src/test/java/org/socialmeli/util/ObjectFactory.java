...
public class ObjectFactory {
    ...
    public NewPost getNewPost() {
        ProductDto productDto = new ProductDto(1234, "producto", "tipo", "marca", "color", "notas");
        return new NewPost(1, "2024-01-03", productDto, 2323, 123.45);
    }

    public NewPost getNewInvalidPost() {
        ProductDto productDto = new ProductDto(1234, "producto", "tipo", "marca", "color", "notas");
        return new NewPost(1234, "2024-01-03", productDto, 2323, 123.45);
    }
}
