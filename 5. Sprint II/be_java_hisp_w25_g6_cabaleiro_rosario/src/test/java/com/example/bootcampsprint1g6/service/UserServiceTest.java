...
import com.example.bootcampsprint1g6.util.builder.UserTestGenerator;
...
import static com.example.bootcampsprint1g6.util.builder.UserTestGenerator.*;
...
public class UserServiceTest {
    ...
    public void unfollowTestWhenSameUser() {
        ...
        // Act & Assert
        Exception exception = assertThrows(BadRequestException.class, () -> userService.unfollow(idUser, idUser));
    ...
    public void unfollowTestWhenUserNotFollowing() {
        ...
        Exception exception = assertThrows(BadRequestException.class, () -> userService.unfollow(idUserWhoUnfollows, idUserToBeUnfollowed));
