...
public class PostRepository implements IPostRepository {
    ...
    public void loadPostList(){
        ...
        postList.add(new Post(postIdCounter+1, 29, 25, currentDate.minusDays(6), productList.get(1), 78.0));
        postList.add(new Post(postIdCounter+2, 29, 25,  currentDate, productList.get(1), 78.0));
        postList.add(new Post(postIdCounter+3, 29, 25, currentDate.minusDays(4), productList.get(1), 78.0));
        postList.add(new Post(postIdCounter+4, 29, 25, LocalDate.of(2024,1,10), productList.get(1), 78.0));
        postList.add(new Post(postIdCounter+5, 30, 25, currentDate.minusDays(6), productList.get(1), 78.0));
    }
