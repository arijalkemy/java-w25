...
class UserServiceTest {
  ...
  void getFollowedAsc() {
    ...
    assertNotNull(userService.getFollowed(clientId, order));
    assertNotEquals(0, userService.getFollowed(clientId, order).followed().size());
  }
  ...
  void getFollowersAscName() {
    ...
    //Act Assert
    assertNotNull(userService.getFollowers(sellerId, order));
    assertNotEquals(0, userService.getFollowers(sellerId, order).followed().size());
  }
  ...
  void getErrorOrderName(){
    ...
    //Act Assert
    assertThrows(BadRequestException.class, ()->userService.getFollowed(clientId, order));
  }
