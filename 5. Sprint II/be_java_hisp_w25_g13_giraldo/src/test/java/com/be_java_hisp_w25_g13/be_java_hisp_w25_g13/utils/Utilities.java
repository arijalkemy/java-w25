...
public class Utilities {
    ...
    public static PostResponseDTO generatePostResponseDto(Integer userId, Integer postId, LocalDate date, Integer productId, String productName){
        return new PostResponseDTO(userId, postId, date, generateProductDto(productId, productName),  1, 10.0);
    }

    public static SellerPostDTO generateSellerPostDto(Integer userId){
        return new SellerPostDTO(
                userId,
                List.of(
                        generatePostResponseDto(21, 0, LocalDate.parse("2024-02-19"), 1, "Arepa"),
                        generatePostResponseDto(21, 1, LocalDate.parse("2024-02-26"), 2, "Papas"),
                        generatePostResponseDto(21, 3, LocalDate.parse("2024-02-28"), 4, "Azucar")
                )
        );
    }

    public static SellerPostDTO generateSellerPostDtoAsc(Integer userId){
        return new SellerPostDTO(
                userId,
                List.of(
                        generatePostResponseDto(21, 0, LocalDate.parse("2024-02-19"), 1, "Arepa"),
    ...
    public static SellerPostDTO generateSellerPostDtoDesc(Integer userId){
        return new SellerPostDTO(
                userId,
                List.of(
                        generatePostResponseDto(21, 3, LocalDate.parse("2024-02-28"), 4, "Azucar"),
