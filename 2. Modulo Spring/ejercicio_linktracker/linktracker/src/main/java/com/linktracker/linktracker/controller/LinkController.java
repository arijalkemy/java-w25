...
public class LinkController {
    ...
    public RedirectView redirectLink(@PathVariable("linkId") int linkId,
        ...
        if(redirectDTO != null){
            return new RedirectView(redirectDTO.getUri());
        }
        throw new NotFoundException("Error loading page");
    }
