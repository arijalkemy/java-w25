...
public class PersonasRepository {
    List<Persona> personas = Arrays.asList(
            ...
            new Persona("Cucho", "Serna",65),
            new Persona("Chancho", "Deca",75),
            new Persona("Chicho", "Chanchi",85),
    ...
    public List<Persona> getPersonasDeRiesgo(){
        return personas.stream().filter(persona -> persona.getEdad() >= 60).collect(Collectors.toList());
    }
}
