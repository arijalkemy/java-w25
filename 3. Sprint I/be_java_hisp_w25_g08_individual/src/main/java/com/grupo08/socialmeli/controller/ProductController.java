...
public class ProductController {
    ...
    public ResponseEntity<?> insertPromoPost(@RequestBody PostDto postDto) {
        return new ResponseEntity<>(postService.insertPost(postDto), HttpStatus.OK);
    }

    @GetMapping("/promo-post/count")
    public ResponseEntity<?> countPromoPosts(@RequestParam int user_id){
        return new ResponseEntity<>(postService.countPosts(user_id), HttpStatus.OK);
    }
