...
public class PostRepository implements IPostRepository {
    ...
    final List<PostOffer> postsOffer = new ArrayList<>(
            List.of(
                    new PostOffer(
                            1,
                            LocalDate.of(2024, 2, 18),
                            new Product(3, "Carro", "Automatico", "Chevrolet", "Azul", "Nuevo"),
                            3,
                            60000,
                            true,
                            0.1
    ...
    @Override
    public List<PostOffer> findAllPostOffersBySellerId(int sellerId){
        return postsOffer.stream()
                .filter(postOffer -> postOffer.getUserId() == sellerId)
                .toList();
    }
    @Override
    ...
    @Override
    public PostOffer addPostOffer(PostOffer postOffer){
        postsOffer.add(postOffer);
        return postOffer;
    }
