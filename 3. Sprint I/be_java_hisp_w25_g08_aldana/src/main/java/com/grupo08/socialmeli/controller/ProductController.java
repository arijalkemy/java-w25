...
public class ProductController {
    ...
    public ResponseEntity<?> getQuantityPromoPostBySeller(@RequestParam int user_id){

        return ResponseEntity.ok().body(postService.getQuantityPromoPostBySeller(user_id));
    }

    @GetMapping("/promo-post/list")
    public ResponseEntity<?> getPromoPostsBySeller(@RequestParam int user_id){

        return ResponseEntity.ok().body(postService.getPromoPostsBySeller(user_id));
    }
