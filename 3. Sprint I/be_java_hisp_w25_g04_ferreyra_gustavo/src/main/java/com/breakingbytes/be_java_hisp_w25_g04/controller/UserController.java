...
public class UserController {
    ...
    @PostMapping("/{userId}/block/{userIdToBlock}")
    public ResponseEntity<?> blockUser(@PathVariable("userId") int userId, @PathVariable("userIdToBlock") int userIdToBlock) {
        userService.block(userId, userIdToBlock);
        return ResponseEntity
                .ok().build();
    }
