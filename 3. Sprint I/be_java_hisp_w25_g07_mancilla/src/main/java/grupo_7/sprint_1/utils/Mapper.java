...
public class Mapper {
    ...
    public static Post convertPostPromoDtoToPost(PostPromoDto postPromo) {
        return new Post(
                convertProductDtoToProduct(postPromo.product()),
                postPromo.category(),
                postPromo.price(),
                postPromo.date(),
                postPromo.hasPromo(),
    ...
    public static PostPromoDto convertPostPromoToDto(int idUser, Post postPromo) {
        return new PostPromoDto(
                idUser,
                postPromo.getDate(),
                convertProductToProductDto(postPromo.getProduct()),
                postPromo.getCategory(),
                postPromo.getPrice(),
                postPromo.getHasPromo(),
