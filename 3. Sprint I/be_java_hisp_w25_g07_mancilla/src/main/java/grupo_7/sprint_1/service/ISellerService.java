...
public interface ISellerService {
    ...
    MessageDto addPostPromo(int idUser, PostPromoDto postPromo);

    PostPromoResponseDto countPostPromoByUserId(int idUser);

    PostPromoListDto getAllPromoByIdUser(int userId);
}
