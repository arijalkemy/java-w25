...
public class ProductController {
    ...
    public ResponseEntity<?> insertPromoPost(@RequestBody PromoPostDto promoPostDto){
        return  new ResponseEntity<>(postService.insertPromoPost(promoPostDto),HttpStatus.OK);
    }

    @GetMapping("/promo-post/count")
    public ResponseEntity<?> promoPostCount(@RequestParam int id){
        return  new ResponseEntity<>(postService.countPromoPost(id),HttpStatus.OK);
    }
