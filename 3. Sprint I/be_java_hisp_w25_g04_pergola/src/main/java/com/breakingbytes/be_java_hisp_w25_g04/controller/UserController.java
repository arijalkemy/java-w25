...
public class UserController {
    ...
    public ResponseEntity<?> getPromoProdCount(@RequestParam(required = false, defaultValue = "") String user_id) {
        return ResponseEntity.ok().body(sellerService.getCountPromoProds(user_id));
    }
}
