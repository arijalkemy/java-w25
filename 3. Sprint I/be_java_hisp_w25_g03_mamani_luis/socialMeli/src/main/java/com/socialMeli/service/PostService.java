...
public class PostService implements IPostService {
    ...
    public PromoProductsCountDto getPromoProductsCount(Integer userId) {
        User user = (User) userRepository.findUserByUserId(userId)
                .orElseThrow(() -> new NotFoundException("No se encuentra usuario con id: " + userId));

        int promoProductsCount = postRepository.countPromoProductsByUserId(userId);
