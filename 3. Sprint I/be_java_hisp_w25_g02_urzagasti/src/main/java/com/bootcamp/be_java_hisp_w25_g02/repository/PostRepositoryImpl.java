...
{
    private List<Post> postList = new ArrayList<>(List.of(
            ...
            new Post(2, 7, LocalDate.of(2024, 02, 17),
            ...
            new Post(4, 9, LocalDate.of(2024, 02, 18),
    ...
    @Override
    public List<Post> findPromoPost(Integer userId) {
        return this.postList.stream().filter(post -> Objects.equals( post.getUser_id(), userId) && post.getHas_promo()).toList();
    }
