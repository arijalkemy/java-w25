...
public class UserController {
    ...
    /*
    Obtener un listado de los vendedores con mas seguidores ordenado de forma descendente
    */
    @GetMapping("/top-followers")
    public ResponseEntity<SellersWithTopFollowersDTO> topFollowers(@RequestParam(required = false, defaultValue = "10") Integer maxRecords){
        return ResponseEntity.status(HttpStatus.OK).body(userService.getTopFollowers(maxRecords));
    }
