...
public class PostController{
    ...
    public ResponseEntity<?> countPromoPost(@RequestParam(value = "user_id") Integer user_id){
        return new ResponseEntity<>(postService.countPromoPost(user_id), HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> getPostList(@RequestParam int user_id, @RequestParam(value="order", required = false) String order){
        return new ResponseEntity<>(postService.countPromoPost(user_id, order),HttpStatus.OK);
    }
}
