...
public class ApiMapper {
    ...
    public static PromoPostDto convertToPromoPostDto(Post post){
        ...
        postDto.setCategory(post.getCategory());
        postDto.setPrice(post.getPrice());
        postDto.setHas_promo(post.getHasPromo());
    ...
    public static Post convertToPostEntity(PromoPostDto postDto){
        ...
        post.setCategory(postDto.getCategory());
        post.setPrice(postDto.getPrice());
        post.setHasPromo(postDto.getHas_promo());
