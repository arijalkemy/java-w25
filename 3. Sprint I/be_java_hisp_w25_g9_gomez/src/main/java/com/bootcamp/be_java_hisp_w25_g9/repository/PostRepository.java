...
public class PostRepository implements IPostRepository {
    ...
    public void loadPostList(){
        ...
        postList.add(new PromoPost(postIdCounter++, 26, 25, LocalDate.of(2024,02,20), productList.get(5), 92.0,true,0.4));
        postList.add(new PromoPost(postIdCounter++, 26, 25, LocalDate.of(2024,02,20), productList.get(11), 130.0,true,0.1));
        postList.add(new PromoPost(postIdCounter++, 27, 25, LocalDate.of(2024,02,20), productList.get(14), 70.0,true,0.15));
    }
