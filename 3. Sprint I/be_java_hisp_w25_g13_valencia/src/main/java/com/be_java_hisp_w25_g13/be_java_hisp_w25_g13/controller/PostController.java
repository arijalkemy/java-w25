...
public class PostController {
    ...
    public ResponseEntity<NumberPromoPostDTO> getCountPromoProducts(@RequestParam Integer userId){
        return new ResponseEntity<>(postService.getCountPromoProducts(userId), HttpStatus.OK);
    }

    @GetMapping("/promo-post/list")
    public ResponseEntity<PostPromosDTO> getPromoProducts(@RequestParam Integer userId){
