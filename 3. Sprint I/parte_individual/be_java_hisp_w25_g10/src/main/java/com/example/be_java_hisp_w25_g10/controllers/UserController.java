...
public class UserController {
    ...
    @GetMapping("users/{userId}/products/discounts/quantity")
    public ResponseEntity<DiscountedProductsCountDto> getSellerDiscountedproducts(@PathVariable int userId) {
        return ResponseEntity.ok().body(userService.getSellerDiscountedProductsCount(userId));
    }
