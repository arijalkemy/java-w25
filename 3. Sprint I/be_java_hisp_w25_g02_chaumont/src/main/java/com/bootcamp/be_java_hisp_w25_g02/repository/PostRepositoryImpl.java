...
public class PostRepositoryImpl implements IPostRepository {
    List<Post> postList = new ArrayList<>(List.of(
            ...
            new Post(1, 9, LocalDate.of(2000, 01, 01),
                    new Product(5, "Pelopincho", "Piletas", "XXX", "Azul", "2000 litros"),
                    3, 40000.0, true, 5000.0),
            new Post(2, 7, LocalDate.of(2010, 05, 05),
                    new Product(6, "Robot", "Juguetes", "XXX", "Amarillo", "Electrico"),
                    4, 100000.0, true, 10000.0)
    ));
    ...
    @Override
    public List<Post> getPromoPost(Integer userId) {
        return this.postList.stream().filter(post -> Objects.equals( post.getUser_id(), userId) && post.isHas_promo()).toList();
    }
}
