...
public class ProductController {
    ...
    public ResponseEntity<?> newPromoPost(@RequestBody PostDTO promoPost) {
        return new ResponseEntity<>(this.postService.newPromoPost(promoPost), HttpStatus.OK);
    }

    @GetMapping("products/promo-post/count")
    public ResponseEntity<?> getPromoPostCount(@RequestParam Integer user_id){
        return new ResponseEntity<>(this.postService.getPromoCountByUser(user_id),HttpStatus.OK);
    }
    //Bonus searchPostByCategory
    @GetMapping("products/post/category")
    public ResponseEntity<?> searchPostByCategory(@RequestParam Integer category){
        return new ResponseEntity<>(this.postService.searchPostByCategory(category),HttpStatus.OK);
    }
