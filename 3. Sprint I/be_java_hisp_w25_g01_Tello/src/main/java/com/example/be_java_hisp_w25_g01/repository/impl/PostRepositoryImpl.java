...
public class PostRepositoryImpl implements IPostRepository {
    ...
    private void loadPost(){
        this.listOfPost =  new ArrayList<>(List.of(
                ...
                new Post(7, 4, LocalDate.of(2024, Month.FEBRUARY, 18), productRepository.findById(15).get(),110, 200000.00,true,0.15),
                new Post(8, 4, LocalDate.of(2024, Month.FEBRUARY, 17), productRepository.findById(16).get(),110, 200000.00,true,0.5),
                new Post(9, 4, LocalDate.of(2024, Month.JANUARY, 17), productRepository.findById(16).get(),110, 200000.00,true,0.5)
        ));
    }
