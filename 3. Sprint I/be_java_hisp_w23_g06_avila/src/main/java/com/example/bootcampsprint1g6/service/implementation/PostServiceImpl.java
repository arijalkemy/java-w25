...
public class PostServiceImpl implements IPostService {
    ...
    public PostResponseDTO createPost(PostRequestDTO request){
        ...
        System.out.println(postCreated);
    ...
    @Override
    public PostCountResponseDTO getPromoCountById(Integer userId){
    ...
    @Override
    public PostPromoListResponseDTO getPromoListById(Integer userId){
        User user = getUserById(userId);
        if (user.getClass() != Seller.class) {
            throw new BadRequestException("El ID ingresado no corresponde a un vendedor, por favor verificarlo.");
        }
