...
public class PostRepositoryImpl implements IPostRepository {
    ...
    public PostRepositoryImpl() {
        ...
        Post post1 = new Post(1, LocalDate.now(), product1, 1, 500.0, true, 0.5);
        Post post2 = new Post(2, LocalDate.now().minusDays(5), product2, 2, 300.0, true, 0.2);
        Post post3 = new Post(3, LocalDate.now().minusWeeks(2), product1, 1, 250.0, true, 1);
        this.setCounter(4);
