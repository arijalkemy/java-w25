...
public class Mapper {
    ...
    public static PostResponseDto mapToPostDto(Post postToMap, Integer sellerId){
        ...
        return new PostResponseDto(
                ...
                postToMap.getPrice(),
                String.valueOf(postToMap.isHasPromo()),
    ...
    public static Post convertDtoPromoToPost(PostPromoDto postPromoDto, Integer postId) {
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd-MM-yyyy");
        return new Post(
                postId,
                ...
                Boolean.parseBoolean(postPromoDto.getHas_promo()),
