...
public class SellerServiceImpl implements ISellerService{
    ...
    public void addPost(RequestPostDTO requestPostDTO) {
        ...
        //Using constructor because of odd behaviour of Mapper with Id of Post
        Post post = new Post(requestPostDTO.getUserId(),
                requestPostDTO.getDate(),
                requestPostDTO.getProduct(),
                requestPostDTO.getCategory(),
                requestPostDTO.getPrice());
        if(requestPostDTO.isHasPromo()){
            post.setHasPromo(true);
            post.setDiscount(requestPostDTO.getDiscount());
        }
