...
public class PostValidator {
    ...
    public static boolean validatePromoRequestDTO(PostPromoRequestDTO request){
        return validateRequestDTO(request) && (request.getHasPromo() != null && request.getHasPromo() != false) && request.getDiscount() != null;
    }
}
