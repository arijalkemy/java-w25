...
public class PostServiceImp implements IPostService {
    ...
    public ExceptionDto insertPostPromo(PostPromoDto postPromoDto){
        ...
        Post post = PostMapper.fromPostPromoDto(postPromoDto);
        postRepository.insertPost(post);
    ...
    public List<PostPromoDto> getAllPromos() {
        List<PostPromoDto> listPostDtos = PostMapper.ListToPostPromoDto(postRepository.getAll());
        return listPostDtos;
    }

    @Override
    public PromoPostxSellerDto getPromoPostxSeller(int user_id) {       
        return postRepository.getPromoPostxSeller(user_id);
    }
