...
public class OrderBy {
    ...
    public static List<Post> orderByPromoAsc(List<Post> listPosts){
        return listPosts.stream()
                .sorted((x,y)->x.getProduct().getProductName().compareTo(y.getProduct().getProductName()))
                .toList();
    }
    public static List<Post> orderByPromoDes(List<Post> listPosts){
        return listPosts.stream()
                .sorted((x,y)->y.getProduct().getProductName().compareTo(x.getProduct().getProductName()))
                .toList();
    }
}
