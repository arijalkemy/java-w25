...
public class PostRepositoryImpl implements IPostRepository{
    ...
    public List<Post> filterPostPromByIdUsuario(Integer idUsuario) {
        return posts.stream().filter(x -> x.getUserId().equals(idUsuario)&& Boolean.TRUE.equals(x.getHas_promo())).toList();
    }
}
