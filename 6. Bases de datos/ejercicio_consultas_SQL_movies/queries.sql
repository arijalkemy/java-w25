...
SELECT title AS 'Titulo', rating AS 'Rating', DATE_FORMAT(release_date, '%Y-%m-%d') AS 'Fecha Estreno' FROM movies
WHERE release_date BETWEEN '2004-01-01' AND '2008-12-31';

-- Traer el título de las películas con el rating mayor a 3, con más de 1 premio y con fecha de lanzamiento entre el año 1988 al 2009. Ordenar los resultados por rating.
SELECT title AS 'Titulo', rating AS 'Rating', awards AS 'Premios', date_format(release_date, '%Y-%m-%d') AS 'Fecha Estreno' FROM movies
