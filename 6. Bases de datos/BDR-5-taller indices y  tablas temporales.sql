...
# actualizar la pelicula agregada con el genero agregado
update movies mo
set mo.genre_id = 13
where mo.id = 999;
...
# esta bien la consulta pero hay que modificar el workbench: Error Code: 1175. You are using safe update mode and you tried to update a table without a WHERE that uses a KEY column.  To disable safe mode, toggle the option in Preferences -> SQL Editor and reconnect.
...
si existe una mejora en la consulta dentro de las base de datos
