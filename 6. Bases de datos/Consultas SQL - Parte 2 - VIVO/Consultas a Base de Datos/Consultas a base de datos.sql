...
SELECT title as Titulo, rating as Rating FROM movies WHERE title = "Toy Story";

# Mostrar a todos los actores cuyos nombres empiezan con Sam.
SELECT first_name as Nombre, last_name as Apellido FROM actors WHERE first_name LIKE "%Sam%";

# Mostrar el título de las películas que salieron entre el 2004 y 2008.
SELECT title as Titulo, release_date as Fecha_lanzamiento FROM movies WHERE release_date BETWEEN "2004-01-01" AND "2008-12-31";
