# Ejercicio Grupal Consutas SQL parte 2 Ejercicio 2.
# grupo 14
...
create table Cliente_Plan (
    ...
    -- Insertar 10 registros en la tabla Cliente_Plan
...
# traer los nombres y el numero de veces que se contrató cada plan
select count(*) as cantidad, pl.name as nombre from cliente_plan as cl_pl
inner join plan as pl on cl_pl.id_plan = pl.id_plan
group by cl_pl.id_plan;

# Traer el nombre al plan mas vendido

SELECT id_plan as cantidad, name FROM (
