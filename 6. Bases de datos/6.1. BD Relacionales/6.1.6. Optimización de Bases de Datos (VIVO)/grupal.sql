...
# Considero que sí otorgaría una mejora notable el crear índices en movies, sobre todo para el campo title, dado que las
# búsquedas por título pueden ser frecuentes y son más costosas por ser un campo de texto, y más aún al realizar la
# consulta por medio de análisis de patrones con los comodines % o _ 

-- ¿En qué otra tabla crearía un índice y por qué? Justificar la respuesta

# Similar al análisis de la anterior pregunta, haría índices en los campos de las tablas que más puedan ser buscados, como
# pueden ser: first_name y last_name de actors, title de movies y de series, name de genres, email de users.