...
/*
 * Se mejora la velocidad en la busqueda de las peliculas por el nombre pero se reelentiza la insercion y modificacion
 * de los datos por una reindexacion cuando se produce
 */
#¿En qué otra tabla crearía un índice y por qué? Justificar la respuesta
/*
 * en la tabla actores indexaria el campo nombre porque es un campo el cual se va a consultar frecuentemente
 */